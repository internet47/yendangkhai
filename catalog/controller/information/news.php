...
class ControllerInformationNews extends Controller {
	public function index() {
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'description' 	=> (strlen(strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES))) > 300 ? substr(strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES)), 0, 300) . '...' : strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES))),
	...
	public function news() {
		...
		if ($news) {
			...
			$data['short_description'] = html_entity_decode($news['short_description'], ENT_QUOTES);
