...
$_['text_i_am_returning_customer']            = 'Vui lòng nhập thông tin tài khoản mà bạn đã đăng ký:';
$_['text_register']                           = '<span style="color:#365D00 ; font-size: 14px; font-weight:bold;">Đăng ký tài khoản mới</span>';
$_['text_guest']                              = '<span style="color:#365D00 ; font-size: 14px; font-weight:bold;">Mua nhanh (không cần đăng ký thành viên)</span>';
$_['text_register_account']                   = '&#9654; Bằng việc <strong>Đăng ký tài khoản mới</strong> bạn có thể theo dõi trạng thái đơn hàng, theo dõi đơn hàng mà bạn đã đặt, thông tin khuyến mãi của cửa hàng...';
$_['text_forgotten']                          = 'Quên Mật Khẩu';
$_['text_logged']                             = 'Bạn đã đăng nhập với tư cách là: <a href="%s">%s</a> <b>(</b> <a href="%s">Thoát</a> <b>)</b>';
...
$_['entry_address_2']                         = 'Địa chỉ 2 (nếu có)';
...
$_['entry_shipping']                          = '<span style="color: red; font-size: 14px;"><strong>Hãy chọn nếu địa chỉ nhận hàng và địa chỉ thanh toán của tôi giống nhau.</strong></span>';
