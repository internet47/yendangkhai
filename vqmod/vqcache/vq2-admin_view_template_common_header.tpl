...
<?php echo (isset($_GET['route']) and $_GET['route'] == 'custom/filemanager') ? '<script type="text/javascript" src="view/javascript/manager/js/jquery-1.7.1.min.js"></script>' : '<script type="text/javascript" src="view/javascript/jquery/jquery-2.1.1.min.js"></script>' ;?>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" width="100%" /></a></div>
  <?php if ($logged) { ?>
