...
$this->language->load('custom/filemanager_my');
...
$data['text_filemanager_my'] = $this->language->get('text_filemanager_my');
...
$data['filemanager_my'] = $this->url->link('custom/filemanager', 'token=' . $this->session->data['token'], 'SSL');
