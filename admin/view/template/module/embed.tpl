      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-support" class="form-horizontal">
          <div class="form-group">
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label" for="input-style"><?php echo $entry_embed; ?></label>
            <div class="col-sm-10">
              <textarea name="embed" id="input-css" class="form-control" cols="1" rows="10" ><?php echo $embed; ?></textarea>
            </div>
          </div>
